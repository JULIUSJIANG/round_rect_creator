                ...
                NodeModules.react.createElement (
                    ...
                    NodeModules.react.createElement (
                        NodeModules.antd.InputNumber,
                        {
                            ...
                            [DomDefine.PROPS_ON_CHANGE]: (val) => {
                                record.marginBottom = val as any;
                                MgrData.inst.callDataChange ();
                            }
                        }
                    )
