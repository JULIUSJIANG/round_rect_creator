...
class c_dom_right extends c_modules.react.Component {
    render() {
        ...
        if (current_record) {
            list_children.push(c_modules.react.createElement(c_dom_right_radius_padding), c_modules.react.createElement(c_dom_right_size_serration_color), c_modules.react.createElement(c_dom_right_type));
        }
        ;
