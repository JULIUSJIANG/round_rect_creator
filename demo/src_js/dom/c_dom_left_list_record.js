...
class c_dom_left_list_record extends c_modules.react.Component {
    render() {
        ...
        for (let i = 0; i < list_record.length; i++) {
            ...
            ;
            list_children.push(c_modules.react.createElement(c_dom_define.t_div, props_div, c_modules.react.createElement(c_dom_left_list_record_input, {
            ...
            }), c_modules.react.createElement(c_modules.antd.Button, props_btn, `选择`)));
        }
        ;
        // 滚动视图的容器
