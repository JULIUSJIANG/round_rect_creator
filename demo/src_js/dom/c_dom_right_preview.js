...
class c_dom_right_preview extends c_modules.react.Component {
    constructor() {
         ...
         * 顶点位置
         */
        this.a_v_position = new c_webgl_ctx_props(`a_v_position`, c_webgl_rs_origin.t_attribute, c_webgl_rs_type.t_vec4);
        /**
         * 取样位置
         */
        this.v_f_position = new c_webgl_ctx_props(`v_f_position`, c_webgl_rs_origin.t_varying, c_webgl_rs_type.t_vec2);
        /**
         * 尺寸
         */
        this.u_f_size = new c_webgl_ctx_props(`u_f_size`, c_webgl_rs_origin.t_uniform, c_webgl_rs_type.t_vec2);
        /**
         * 左上半径
         */
        this.u_radius_lt = new c_webgl_ctx_props(`u_radius_lt`, c_webgl_rs_origin.t_uniform, c_webgl_rs_type.t_float);
        /**
         * 右上半径
         */
        this.u_radius_rt = new c_webgl_ctx_props(`u_radius_rt`, c_webgl_rs_origin.t_uniform, c_webgl_rs_type.t_float);
        /**
         * 右下半径
         */
        this.u_radius_rb = new c_webgl_ctx_props(`u_radius_rb`, c_webgl_rs_origin.t_uniform, c_webgl_rs_type.t_float);
        /**
         * 左下半径
         */
        this.u_radius_lb = new c_webgl_ctx_props(`u_radius_lb`, c_webgl_rs_origin.t_uniform, c_webgl_rs_type.t_float);
        /**
         * 着色
         */
        this.u_color = new c_webgl_ctx_props(`u_color`, c_webgl_rs_origin.t_uniform, c_webgl_rs_type.t_vec4);
        /**
         * 当前模式代号
         */
        this.u_current_code = new c_webgl_ctx_props(`u_current_code`, c_webgl_rs_origin.t_uniform, c_webgl_rs_type.t_float);
        /**
         * 线框模式 - 线宽
         */
        this.u_code_1_line_width = new c_webgl_ctx_props(`u_code_1_line_width`, c_webgl_rs_origin.t_uniform, c_webgl_rs_type.t_float);
        /**
         * 向内淡出 - 淡出距离
         */
        this.u_code_2_fade_distance = new c_webgl_ctx_props(`u_code_2_fade_distance`, c_webgl_rs_origin.t_uniform, c_webgl_rs_type.t_float);
        /**
         * 向内淡入 - 淡入距离
         */
        this.u_code_3_fade_distance = new c_webgl_ctx_props(`u_code_3_fade_distance`, c_webgl_rs_origin.t_uniform, c_webgl_rs_type.t_float);
    }
    componentDidMount() {
        this.webgl_canvas = this.canvas_ref.current;
        this.webgl_ctx = this.webgl_canvas.getContext(`webgl`);
        this.webgl_program = c_webgl.f_create_program(this.webgl_ctx, `
