...
(function (c_data_item_ctx_record_rs) {
    /**
     * 代号到具体策略的映射
     */
    c_data_item_ctx_record_rs.map_code_to_rs = new Map();
    /**
     * 策略的集合
     */
    c_data_item_ctx_record_rs.list_rs = new Array();
    /**
     * 纯色模式
     */
    c_data_item_ctx_record_rs.i_pure = new c_data_item_ctx_record_rs({
        code: 0,
        name: "纯色模式",
        filter: () => {
            return [];
     ...
     * 线框模式
     */
    c_data_item_ctx_record_rs.i_frame = new c_data_item_ctx_record_rs({
        code: 1,
        name: "线框模式",
        filter: () => {
            ...
            return [
                ...
                }, "线宽"), c_modules.react.createElement(c_modules.antd.InputNumber, {
                    min: 0,
                    style: {
     ...
     * 向内淡出
     */
    c_data_item_ctx_record_rs.i_fade_out = new c_data_item_ctx_record_rs({
        code: 2,
        name: "向内淡出",
        filter: () => {
            let record = c_index_client.f_get_current_record();
            return [
                ...
                }, "淡出距离"), c_modules.react.createElement(c_modules.antd.InputNumber, {
                    min: 0,
                    style: {
                        [c_dom_define.s_width]: c_dom_define.s_width_percentage_0,
                        [c_dom_define.s_flex_grow]: 1
                ...
                }, "淡出变速"), c_modules.react.createElement(c_modules.antd.Slider, {
                    min: -4,
                    max: 4,
                    step: 0.01,
                    style: {
     ...
     * 向内淡入
     */
    c_data_item_ctx_record_rs.i_fade_in = new c_data_item_ctx_record_rs({
        code: 3,
        name: "向内淡入",
        filter: () => {
            let record = c_index_client.f_get_current_record();
            return [
                ...
                }, "淡入距离"), c_modules.react.createElement(c_modules.antd.InputNumber, {
                    min: 0,
                    style: {
                        [c_dom_define.s_width]: c_dom_define.s_width_percentage_0,
                        [c_dom_define.s_flex_grow]: 1
                ...
                }, "淡入变速"), c_modules.react.createElement(c_modules.antd.Slider, {
                    min: -4,
                    max: 4,
                    step: 0.01,
                    style: {
...
})(c_data_item_ctx_record_rs || (c_data_item_ctx_record_rs = {}));
