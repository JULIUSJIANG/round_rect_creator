...
import DomRightRadiusMargin from "./DomRightRadiusMargin.js";
import DomRightType from "./DomRightType.js";
import IndexWindow from "../IndexWindow.js";
import DomRightSizeSerrationColor from "./DomRightSizeSerrationColor.js";
/**
 * 右边栏
 */
class DomRight extends NodeModules.react.Component {
    render() {
        ...
        if (currentRecord) {
            listChildren.push(NodeModules.react.createElement(DomRightRadiusMargin), NodeModules.react.createElement(DomRightSizeSerrationColor), NodeModules.react.createElement(DomRightType));
        }
        ;
